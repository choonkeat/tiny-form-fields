...
import { addField, clickCollectDataCheckbox, attemptSubmitWithExpectedFailure, submitExpectingSuccess, viewForm } from './test-utils';

test('checkbox min/max constraints in Editor and CollectData modes', async ({ page, browserName }) => {

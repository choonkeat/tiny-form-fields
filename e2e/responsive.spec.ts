...
test.describe("responsive layout tests", () => {
  ...
  test("2 column layout has correct structure and panel switching behavior", async ({ page }) => {
    ...
    const initialCenterPanelHeight = await page.locator(".tff-center-panel").evaluate((el) => el.clientHeight);
  ...
  test("mobile view layout has correct structure and panel switching behavior", async ({ page }) => {
    ...
    const finalCenterPanelHeight = await page.locator(".tff-center-panel").evaluate((el) => el.clientHeight);

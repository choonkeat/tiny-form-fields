...
{
	if (region.a1.ay === region.bi.ay)
	{
		return 'on line ' + region.a1.ay;
	}
	return 'on lines ' + region.a1.ay + ' through ' + region.bi.ay;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bn: fragment, bt: host, bJ: path, bL: port_, bP: protocol, bQ: query};
	});
...
var $author$project$Main$Config = F4(
	function (viewMode, formFields, formValues, shortTextTypeList) {
		return {d: formFields, aU: formValues, ab: shortTextTypeList, S: viewMode};
	});
var $elm_community$json_extra$Json$Decode$Extra$andMap = $elm$json$Json$Decode$map2($elm$core$Basics$apR);
var $author$project$Main$FormField = F6(
	function (label, name, presence, description, type_, visibilityRule) {
		return {N: description, h: label, aA: name, u: presence, f: type_, v: visibilityRule};
	});
...
var $author$project$Main$RawCustomElement = F3(
	function (inputType, inputTag, attributes) {
		return {p: attributes, K: inputTag, y: inputType};
	});
		...
		return A2(
			...
			function (_v0) {
				...
				return $author$project$Main$fromRawCustomElement(
					{p: attributes, K: inputTag, y: inputType});
			},
...
var $author$project$Main$choiceToString = function (choice) {
	return _Utils_eq(choice.h, choice.s) ? choice.h : _Utils_ap(
		choice.s,
					...
					A2(
						...
						_List_fromArray(
							[
								...
								_Utils_Tuple2(
								'visibilityRule',
								A2($elm$json$Json$Encode$list, $author$project$Main$encodeVisibilityRule, formField.v))
							])));
			},
...
var $author$project$Main$init = function (flags) {
	...
	if (!_v0.$) {
		...
		var effectiveShortTextTypeList = _Utils_ap(
			defaultShortTextTypeListWithout(config.ab),
			config.ab);
		return _Utils_Tuple2(
			{
				...
				aL: !$elm$core$Array$isEmpty(
					A2(
						...
						function (f) {
							return !$elm$core$List$isEmpty(f.v);
						},
						config.d)),
...
var $author$project$Main$updateFormField = F5(
	function (msg, index, string, formFields, formField) {
		switch (msg.$) {
			case 0:
				return _Utils_update(
					formField,
				...
				switch (_v2.$) {
					case 0:
						...
						var newCustomElement = _Utils_update(
							customElement,
							{
								az: $author$project$Main$AttributeGiven(bool)
							});
						return _Utils_update(
							formField,
							{
				...
				switch (_v3.$) {
					case 0:
						...
						var newCustomElement = _Utils_update(
							customElement,
							{
								Y: A2($author$project$Main$toggleAttributeOptional, bool, customElement.Y)
							});
						return _Utils_update(
							formField,
							{
								...
								[
									...
									_List_fromArray(
										[
											A2(
											$author$project$Main$Field,
											A2($author$project$Main$getPreviousFieldLabel, index, formFields),
					...
					var newFormFields = A2(
						...
						F2(
							function (i, formField) {
								return _Utils_eq(i, index) ? A5($author$project$Main$updateFormField, fmsg, index, string, model.d, formField) : formField;
							}),
						model.d);
					return _Utils_Tuple2(
						_Utils_update(
							...
							model,
							{
								l: $elm$core$Maybe$Just(
									$author$project$Main$DragExisting(
										{aT: index, D: $elm$core$Maybe$Nothing})),
								B: $elm$core$Maybe$Nothing
							}),
						$elm$core$Platform$Cmd$none);
				case 10:
						...
						$elm$core$Dict$toList(
							A2(
								...
								A2(
									...
									A2($elm$core$Dict$get, customElement.y, config.aa))))));
				var _v1 = function () {
					var _v2 = customElement.W;
					switch (_v2.$) {
						case 2:
							var list = _v2.a;
							return _Utils_Tuple2(
										...
										return A2(
											...
											A2(
												...
												A2(
													$elm$core$List$cons,
													$author$project$Main$defaultSelected(
														_Utils_eq(valueString, choice.s) || chosenForYou(choices)),
													config.T)),
											_List_fromArray(
												[
													$elm$html$Html$text(choice.h)
								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Events$onCheck(options.ag)
										]),
									_List_Nil),
									$elm$html$Html$text(' '),
...
var $author$project$Main$OnVisibilityConditionFieldInput = F2(
	function (a, b) {
		return {$: 12, a: a, b: b};
	});
var $author$project$Main$OnVisibilityConditionTypeInput = F2(
	function (a, b) {
		return {$: 11, a: a, b: b};
	});
var $author$project$Main$OnVisibilityConditionValueInput = F2(
	function (a, b) {
		return {$: 13, a: a, b: b};
	});
									...
									_List_fromArray(
										[
											...
											function (str) {
												return A3(
													$author$project$Main$OnFormField,
													A2($author$project$Main$OnVisibilityRuleTypeInput, ruleIndex, str === 'ShowWhen'),
													index,
													'');
											}),
											$elm$html$Html$Attributes$required(true)
												...
												_List_fromArray(
													[
														...
														function (str) {
															return A3(
																$author$project$Main$OnFormField,
																A2($author$project$Main$OnVisibilityConditionFieldInput, ruleIndex, str),
																index,
																'');
														}),
														$elm$html$Html$Attributes$value(
											...
											bw: _List_fromArray(
												[
													...
													function (str) {
														return A3(
															$author$project$Main$OnFormField,
															A2($author$project$Main$OnVisibilityConditionValueInput, ruleIndex, str),
															index,
															'');
													}),
													$elm$html$Html$Attributes$required(true)
											...
											bY: _List_fromArray(
												[
													...
													function (str) {
														return A3(
															$author$project$Main$OnFormField,
															A2($author$project$Main$OnVisibilityConditionTypeInput, ruleIndex, str),
															index,
															'');
													})
												])
			...
			function (fieldName, choice) {
				return _List_fromArray(
					[
						$elm$html$Html$Events$onCheck(
						function (_v4) {
							return A2($author$project$Main$OnFormValuesUpdated, fieldName, choice.s);
						})
					]);
			});
		var config = {
			T: customAttrs,
			d: formFields,
			a_: needsFormLogic ? onChooseMany : F2(
				function (_v1, _v2) {
					return _List_Nil;
				}),
			aq: needsFormLogic ? onInput : function (_v3) {
				return _List_Nil;
			},
			aa: shortTextTypeDict,
			C: trackedFormValues
		};
		return $elm$core$Array$toList(
			A2(
				...
				A2(
					$elm$core$Array$filter,
					function (formField) {
						return A2($author$project$Main$isVisibilityRuleSatisfied, formField.v, trackedFormValues);
					},
					formFields)));
	});
var $author$project$Main$viewMain = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class(
				'tff tff-container tff-mode-' + $author$project$Main$stringFromViewMode(model.S))
			]),
		function () {
			var _v0 = model.S;
			if (!_v0.$) {
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{cx: $author$project$Main$init, cT: $author$project$Main$subscriptions, cX: $author$project$Main$update, cY: $author$project$Main$view});

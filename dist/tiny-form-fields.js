					...
					A2(
						...
						_List_fromArray(
							[
								...
								_Utils_Tuple2(
								'visibilityRule',
								A2($author$project$Main$encodeAttributeOptional, $author$project$Main$encodeVisibilityRule, formField.l))
							])));
			},
						...
						l: function () {
							if (bool) {
								...
								if (!_v23.$) {
									...
									return A2($author$project$Main$toggleAttributeOptional, bool, formField.l);
								}
							} else {
								return A2($author$project$Main$toggleAttributeOptional, bool, formField.l);
							}

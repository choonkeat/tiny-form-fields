...
var $author$project$Main$fromRawCustomElement = function (ele) {
	return {
		attributes: A2(
			...
			ele.attributes),
		datalist: function () {
			var _v0 = A2($elm$core$Dict$get, 'list', ele.attributes);
			if (_v0.$ === 'Just') {
				var s = _v0.a;
				var _v1 = A2(
		...
		maxlength: function () {
			var _v2 = A2($elm$core$Dict$get, 'maxlength', ele.attributes);
			if (_v2.$ === 'Just') {
				if (_v2.a === '') {
					return $author$project$Main$AttributeNotNeeded($elm$core$Maybe$Nothing);
				} else {
		...
		return _Utils_Tuple2(
			{
				...
				draggedNewField: $elm$core$Maybe$Nothing,
				dropTargetIndex: $elm$core$Maybe$Nothing,
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'MoveFormFieldUp':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							formFields: newFormFields,
							selectedFieldIndex: $elm$core$Maybe$Just(index - 1)
						}),
					$author$project$Main$outgoing(
						$author$project$Main$encodePortOutgoingValue(
							$author$project$Main$PortOutgoingFormFields(newFormFields))));
			...
			case 'SelectField':
				var index = msg.a;
				var _v5 = _Utils_Tuple2(model.selectedFieldIndex, index);
			...
			case 'DragStartNew':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							draggedNewField: $elm$core$Maybe$Just(field)
						}),
					$elm$core$Platform$Cmd$none);
			case 'DragEnd':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{draggedIndex: $elm$core$Maybe$Nothing, draggedNewField: $elm$core$Maybe$Nothing, dropTargetIndex: $elm$core$Maybe$Nothing}),
					$elm$core$Platform$Cmd$none);
			case 'DragOver':
				var index = msg.a;
				return ((index >= 0) && (_Utils_cmp(
					index,
					$elm$core$Array$length(model.formFields)) < 0)) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							dropTargetIndex: $elm$core$Maybe$Just(index)
						}),
			...
			case 'Drop':
				...
				var _v7 = _Utils_Tuple3(model.draggedIndex, model.draggedNewField, model.dropTargetIndex);
				_v7$2:
				while (true) {
					if (_v7.a.$ === 'Just') {
						if ((_v7.b.$ === 'Nothing') && (_v7.c.$ === 'Just')) {
							...
							if (_Utils_eq(draggedIndex, dropTargetIndex)) {
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{draggedIndex: $elm$core$Maybe$Nothing, dropTargetIndex: $elm$core$Maybe$Nothing}),
									$elm$core$Platform$Cmd$none);
							} else {
								var newSelectedFieldIndex = function () {
									var _v10 = model.selectedFieldIndex;
									if (_v10.$ === 'Nothing') {
										return $elm$core$Maybe$Nothing;
									} else {
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{draggedIndex: $elm$core$Maybe$Nothing, dropTargetIndex: $elm$core$Maybe$Nothing, formFields: newFormFields, selectedFieldIndex: newSelectedFieldIndex}),
									$author$project$Main$outgoing(
										$author$project$Main$encodePortOutgoingValue(
											$author$project$Main$PortOutgoingFormFields(newFormFields))));
							}
						...
						if ((_v7.b.$ === 'Just') && (_v7.c.$ === 'Just')) {
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{draggedNewField: $elm$core$Maybe$Nothing, dropTargetIndex: $elm$core$Maybe$Nothing, formFields: newFormFields}),
								$author$project$Main$outgoing(
									$author$project$Main$encodePortOutgoingValue(
										$author$project$Main$PortOutgoingFormFields(newFormFields))));
						} else {
					...
					$elm$core$Dict$toList(
						A2(
							...
							A2(
								...
								A2($elm$core$Dict$get, customElement.inputType, shortTextTypeDict)))));
				var extraAttrs = A2(
					$elm$core$List$filterMap,
					$elm$core$Basics$identity,
					A2(
						...
						A2(
							...
							$elm$core$Dict$toList(customElement.attributes))));
				var _v2 = function () {
					var _v3 = customElement.datalist;
...
var $author$project$Main$viewFormBuilder = F2(
	function (maybeAnimate, model) {
		var rightPanelVisible = !_Utils_eq(model.selectedFieldIndex, $elm$core$Maybe$Nothing);
												...
												[
													...
													$elm$json$Json$Decode$succeed(
														$author$project$Main$DragStartNew(
															{
																description: $author$project$Main$AttributeNotNeeded($elm$core$Maybe$Nothing),
																label: $author$project$Main$stringFromInputField(inputField),
																name: $elm$core$Maybe$Nothing,
																presence: A2(
																	$author$project$Main$when,
										...
										F2(
											function (index, formField) {
												var showPlaceholderBefore = function () {
													var _v9 = _Utils_Tuple3(model.draggedIndex, model.draggedNewField, model.dropTargetIndex);
													_v9$2:
													while (true) {
														if (_v9.a.$ === 'Just') {
															if ((_v9.b.$ === 'Nothing') && (_v9.c.$ === 'Just')) {
												...
												var showPlaceholderAfter = function () {
													var _v6 = _Utils_Tuple3(model.draggedIndex, model.draggedNewField, model.dropTargetIndex);
													_v6$2:
													while (true) {
														if (_v6.a.$ === 'Just') {
															if ((_v6.b.$ === 'Nothing') && (_v6.c.$ === 'Just')) {
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										function () {
										var _v12 = model.selectedFieldIndex;
										if (_v12.$ === 'Just') {
											var index = _v12.a;
											var _v13 = A2($elm$core$Array$get, index, model.formFields);
											if (_v13.$ === 'Just') {
												var formField = _v13.a;
												return A4(
													$author$project$Main$viewFormFieldBuilder,
													model.shortTextTypeList,
													$elm$core$Array$length(model.formFields),
													index,
													formField);
											} else {
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.FormField":{"args":[],"type":"{ label : String.String, name : Maybe.Maybe String.String, presence : Main.Presence, description : Main.AttributeOptional String.String, type_ : Main.InputField }"},"Main.Choice":{"args":[],"type":"{ label : String.String, value : String.String }"},"Main.CustomElement":{"args":[],"type":"{ inputType : String.String, inputTag : String.String, attributes : Dict.Dict String.String String.String, maxlength : Main.AttributeOptional Basics.Int, datalist : Main.AttributeOptional (List.List Main.Choice) }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"OnPortIncoming":["Json.Encode.Value"],"SetViewMode":["Main.ViewMode"],"AddFormField":["Main.InputField"],"DeleteFormField":["Basics.Int"],"MoveFormFieldUp":["Basics.Int"],"MoveFormFieldDown":["Basics.Int"],"OnFormField":["Main.FormFieldMsg","Basics.Int","String.String"],"ToggleDropdownState":[],"SetEditorAnimate":["Maybe.Maybe ( Basics.Int, Main.Animate )"],"SelectField":["Maybe.Maybe Basics.Int"],"DragStart":["Basics.Int"],"DragStartNew":["Main.FormField"],"DragEnd":[],"DragOver":["Basics.Int"],"Drop":["Basics.Int"],"DoSleepDo":["Basics.Float","List.List Main.Msg"]}},"Main.Animate":{"args":[],"tags":{"AnimateYellowFade":[],"AnimateFadeOut":[]}},"Main.AttributeOptional":{"args":["a"],"tags":{"AttributeNotNeeded":["Maybe.Maybe a"],"AttributeInvalid":["String.String"],"AttributeGiven":["a"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Main.FormFieldMsg":{"args":[],"tags":{"OnLabelInput":[],"OnDescriptionInput":[],"OnDescriptionToggle":["Basics.Bool"],"OnRequiredInput":["Basics.Bool"],"OnChoicesInput":[],"OnMaxLengthToggle":["Basics.Bool"],"OnMaxLengthInput":[],"OnDatalistToggle":["Basics.Bool"],"OnDatalistInput":[]}},"Main.InputField":{"args":[],"tags":{"ShortText":["Main.CustomElement"],"LongText":["Main.AttributeOptional Basics.Int"],"Dropdown":["List.List Main.Choice"],"ChooseOne":["List.List Main.Choice"],"ChooseMultiple":["List.List Main.Choice"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Presence":{"args":[],"tags":{"Required":[],"Optional":[],"System":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Main.ViewMode":{"args":[],"tags":{"Editor":["{ maybeAnimate : Maybe.Maybe ( Basics.Int, Main.Animate ) }"],"CollectData":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));
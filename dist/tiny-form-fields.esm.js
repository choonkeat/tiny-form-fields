...
var $author$project$Main$FormField = F6(
	function (label, name, presence, description, type_, allowOthers) {
		return {allowOthers: allowOthers, description: description, label: label, name: name, presence: presence, type_: type_};
	});
					...
					A2(
						...
						_List_fromArray(
							[
								...
								_Utils_Tuple2(
								'allowOthers',
								$elm$json$Json$Encode$bool(formField.allowOthers))
							])));
			},
			...
			switch (msg.$) {
				...
				case 'AddFormField':
					...
					var newFormField = {
						...
						label: $author$project$Main$stringFromInputField(fieldType) + ' question',
				...
				case 'SelectField':
					var index = msg.a;
					var _v4 = _Utils_Tuple2(model.selectedFieldIndex, index);
					if ((_v4.a.$ === 'Just') && (_v4.b.$ === 'Nothing')) {
							...
							model,
							{
								dragged: $elm$core$Maybe$Just(
									$author$project$Main$DragExisting(
										{dragIndex: index, dropIndex: $elm$core$Maybe$Nothing})),
								selectedFieldIndex: $elm$core$Maybe$Nothing
							}),
						$elm$core$Platform$Cmd$none);
				case 'DragStartNew':
					...
					return _Utils_Tuple2(
						...
						$elm$core$Platform$Cmd$none);
				case 'DragEnd':
					var _v6 = model.dragged;
					if (_v6.$ === 'Just') {
						if (_v6.a.$ === 'DragExisting') {
							var dropIndex = _v6.a.a.dropIndex;
								...
								$author$project$Main$DragStartNew(
									{
										allowOthers: false,
										description: $author$project$Main$AttributeNotNeeded($elm$core$Maybe$Nothing),
										label: $author$project$Main$stringFromInputField(inputField) + ' question',
										name: $elm$core$Maybe$Nothing,
										presence: A2(
											$author$project$Main$when,
...
var $author$project$Main$OnAllowOthersToggle = function (a) {
	return {$: 'OnAllowOthersToggle', a: a};
};
						...
						$author$project$Main$inputAttributeOptional,
						{
							attrs: _List_fromArray(
								[
									...
									$elm$html$Html$Attributes$type_('checkbox'),
									$elm$html$Html$Attributes$checked(formField.allowOthers)
								]),
							htmlNode: $elm$html$Html$input,
							...
							onInput: function (_v3) {
								return $author$project$Main$NoOp;
							},
							toString: function (_v4) {
								return '';
							}
						},
						formField.allowOthers ? $author$project$Main$AttributeGiven('') : $author$project$Main$AttributeNotNeeded($elm$core$Maybe$Nothing))
					]);
			default:
				var choices = _v0.a;
				return _List_fromArray(
					[
						...
						$author$project$Main$inputAttributeOptional,
						{
							...
							onInput: function (_v5) {
								return $author$project$Main$NoOp;
							},
							toString: function (_v6) {
								return '';
							}
						},
						formField.allowOthers ? $author$project$Main$AttributeGiven('') : $author$project$Main$AttributeNotNeeded($elm$core$Maybe$Nothing))
